...
# Ruta al repositorio de templates del framework
# Ajustar a donde tengas clonado blue-team-writeups
...
def prefill_template(template_path, dest_path, case_name, case_type, date_str):
    ...
    # Pre-rellenar fecha y nombre en el metadata
...
def main():
    ...
    if os.path.exists(case_dir):
        print(f"\n  ⚠️  Ya existe un caso con ese nombre: {case_dir}")
        sys.exit(1)
